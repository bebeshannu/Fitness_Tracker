...
<form action="" id="expense-form">
    ...
    <div class="form-group">
        <label for="category_id" class="control-label">Food Type</label>
        <select name="category_id" id="category_id" class="custom-select select2" required>
        <option value=""></option>
        <?php
            $qry = $conn->query("SELECT * FROM `categories_2` where `balance` > 0 order by category asc");
    ...
    <?php else: ?>
        <div class="form-group">
            <label for="category_id" class="control-label">Activity Type</label>
            <input type="hidden" name="category_id" value="<?php echo $category_id ?>">
            <?php
            $qry = $conn->query("SELECT * FROM `categories_2` where id = '{$category_id}'");
    ...
    <?php endif; ?>
    <div class="form-group">
        <label for="amount" class="control-label">Calories</label>
