...
<div class="card card-primary card-outline">
    <div class="card-header">
        <h5 class="card-title">Calories Burnt Report</h5>
    </div>
    <div class="card-body">
        <form id="filter-form">
        ...
        <div id="printable">
            <div>
                ...
                <h3 class="text-center m-0"><b>Calories Burnt Report</b></h3>
                <hr style="width:15%">
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    $i = 1;
                    $total = 0;
                        $qry = $conn->query("SELECT r.*,c.category,c.balance from `running_balance` r inner join `categories_2` c on r.category_id = c.id where c.status=1 and r.balance_type = 2 and date(r.date_created) between '{$date_start}' and '{$date_end}' order by unix_timestamp(r.date_created) asc");
