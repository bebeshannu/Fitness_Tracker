...
<div class="row">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number text-right">
                  <?php 
                    ...
                    // $cur_bul = $conn->query("SELECT ROUND(weight/(height*height/100),2) as total  FROM `users` where username='admin' ")->fetch_assoc()['total'];
                    // $cur_bul = $conn->query("SELECT ROUND(weight/(height*height/100),2) as total  FROM `users` where username='admin' ")->fetch_assoc()['total'];
                    
                    
                    $info = $conn->query('select weight,height from users where username="'.$_SESSION['userdata']['username'].'"')->fetch_assoc();
                    // $info = $conn->query('select round(weight/(height*height/100),2) from users where username="'.$_SESSION['userdata']['username'].'"')->fetch_assoc()['total'];
                    $cur_bul = $info['weight'];
                    // $info = $conn->query("select weight from users where username='admin'")->fetch_assoc;
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Today's Calories Consumed</span>
                <span class="info-box-number text-right">
                  <?php 
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Today's Calories Burnt</span>
                <span class="info-box-number text-right">
                <?php 
                    ...
                    // $today_expense = $conn->query('select sum(amount) as total from running_balance where date(date_created)="'.(date("Y-m-d")).'" and balance_type = 2 and user_id="(select id from users where username="'.$_SESSION['userdata']['username'].'")')->fetch_assoc()['total'];
